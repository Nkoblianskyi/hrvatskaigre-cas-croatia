...
export const metadata = {
  title: "Politika Kolačića - hrvatskaigre.com",
  description: "Saznajte kako hrvatskaigre.com koristi kolačiće za poboljšanje vašeg iskustva na web stranici.",
}
      ...
      <main className="container mx-auto px-4 py-12">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 leading-relaxed">Kako koristimo kolačiće na hrvatskaigre.com</p>
          ...
          <div className="space-y-12">
            ...
            <section className="bg-[#0a0c10] border border-gray-800 rounded-xl p-8">
              <div className="mb-6">
                <div className="inline-flex items-center gap-2 bg-[#daa520]/20 px-4 py-2 rounded-lg mb-4">
