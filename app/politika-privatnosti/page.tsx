...
export const metadata = {
  title: "Politika Privatnosti - hrvatskaigre.com",
  description: "Saznajte kako hrvatskaigre.com prikuplja, koristi i štiti vaše osobne podatke.",
}
          ...
          <div className="space-y-12">
            ...
            <section className="bg-[#0a0c10] border border-gray-800 rounded-xl p-8">
              ...
              <div className="space-y-4 text-gray-300 leading-relaxed">
                <p>
                  hrvatskaigre.com ("mi", "nas" ili "naš") poštuje vašu privatnost i obvezuje se zaštiti vaše osobne
                ...
                <div className="bg-[#daa520]/10 border border-[#daa520]/30 rounded-lg p-4 mt-4">
                  <p className="text-sm">
                    <strong className="text-[#daa520]">Važno:</strong> Ova Politika privatnosti odnosi se samo na našu
            ...
            <section className="bg-[#0a0c10] border border-gray-800 rounded-xl p-8">
              ...
              <div className="space-y-4 text-gray-300 leading-relaxed">
                ...
                <div className="bg-[#daa520]/10 border border-[#daa520]/30 rounded-lg p-4 mt-6">
                  <p className="text-sm">
                    <strong className="text-[#daa520]">Napomena:</strong> Nikada ne prodajemo vaše osobne podatke trećim
