  ...
  return (
    ...
    >
      <div className="bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 rounded-lg shadow-2xl w-full max-w-[380px] md:max-w-lg relative border border-slate-700/50 overflow-hidden">
        ...
        <div className="h-1 bg-gradient-to-r from-transparent via-[#daa520] to-transparent" />
        ...
        <div className="p-5 md:p-6">
          <div className="text-center mb-4">
            <h2 className="font-bold text-2xl md:text-3xl text-white mb-1 bg-gradient-to-r from-white to-slate-300 bg-clip-text text-transparent">
              Top Casino Preporuka
            </h2>
            <p className="text-slate-400 text-sm">Najbolji izbor za hrvatske igrače</p>
          </div>

          <div className="text-center mb-4">
            <div className="bg-slate-800/50 backdrop-blur-sm rounded-lg p-4 md:p-5 shadow-xl mx-auto w-fit border border-slate-700/50 hover:border-[#daa520]/50 transition-all duration-300">
              <Image
          ...
          <div className="text-center mb-4 bg-gradient-to-br from-slate-800/80 to-slate-900/80 backdrop-blur-sm rounded-lg p-4 border border-slate-700/50 shadow-lg">
            <div className="text-[#daa520] text-xs font-bold uppercase tracking-wider mb-2 flex items-center justify-center gap-2">
              <div className="h-px w-8 bg-[#daa520]/50"></div>
              <span>Ekskluzivni Bonus</span>
              <div className="h-px w-8 bg-[#daa520]/50"></div>
            </div>
          ...
          <div className="mb-3">
            <button
              ...
              className="w-full bg-gradient-to-r from-[#daa520] to-[#ebbe41] hover:from-[#ebbe41] hover:to-[#daa520] text-[#0a0c10] font-bold py-3.5 px-6 rounded-lg transition-all duration-300 shadow-lg shadow-[#daa520]/30 hover:shadow-[#daa520]/50 hover:scale-[1.02] border border-[#daa520]/30 text-base"
            >
              Igraj Sada →
            </button>
          </div>
        ...
        <div className="h-1 bg-gradient-to-r from-transparent via-[#daa520]/30 to-transparent" />
      </div>
    </div>
  )
}
