    ...
    <section className="relative bg-[#06070a] text-white py-8 md:py-12 overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          <div className="inline-flex items-center gap-3 border border-[#c9962d]/20 rounded-sm px-6 py-3 mb-8 backdrop-blur-sm">
            <span className="text-xs uppercase tracking-widest text-gray-400">Ažurirano</span>
            <span className="w-px h-4 bg-[#c9962d]/30" />
            <span className="text-xs uppercase tracking-widest text-[#c9962d]">{currentDate}</span>
          </div>

          <h1 className="font-serif text-3xl md:text-5xl lg:text-6xl font-semibold mb-5 leading-[1.1] tracking-tight">
