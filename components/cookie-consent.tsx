  ...
  return (
    <>
      <div className="fixed bottom-0 inset-x-0 z-50 animate-in slide-in-from-bottom duration-500">
        <div className="bg-gradient-to-br from-[#0f1116] via-[#12151c] to-[#0a0c10] border-t-2 border-[#daa520] shadow-[0_-10px_50px_rgba(218,165,32,0.15)] backdrop-blur-md">
            ...
            <div className="flex flex-col lg:flex-row items-start lg:items-center gap-6 lg:gap-8">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm md:text-base text-gray-300 leading-relaxed max-w-3xl">
                    ...
                    <button
                      ...
                      className="text-[#daa520] hover:text-[#ebbe41] underline underline-offset-2 font-semibold transition-colors inline-flex items-center gap-1"
                    >
                      Pogledajte detalje
                    </button>
                  </p>
              ...
              <div className="flex gap-3 w-full lg:w-auto flex-col sm:flex-row">
                <button
                  ...
                  className="group relative bg-gradient-to-r from-[#daa520] to-[#ebbe41] hover:from-[#ebbe41] hover:to-[#f5d76e] text-[#0a0c10] px-8 py-3.5 rounded-xl font-bold transition-all shadow-lg shadow-[#daa520]/30 hover:shadow-xl hover:shadow-[#daa520]/40 hover:scale-105 uppercase tracking-wider text-sm flex items-center justify-center gap-2"
                >
                ...
                <button
                  onClick={() => setShowModal(true)}
                  className="bg-white/5 hover:bg-white/10 text-white px-8 py-3.5 rounded-xl font-bold transition-all border-2 border-white/20 hover:border-[#daa520]/50 uppercase tracking-wider text-sm backdrop-blur-sm"
                >
                  Postavke
                </button>
                <button
      ...
      {showModal && (
        <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 animate-in fade-in duration-300">
          ...
          <div className="relative bg-gradient-to-br from-[#0f1116] via-[#12151c] to-[#0a0c10] rounded-2xl shadow-2xl max-w-3xl w-full max-h-[90vh] overflow-hidden border-2 border-[#daa520]/30 animate-in zoom-in-95 duration-300">
            {/* Header */}
            <div className="sticky top-0 z-10 bg-gradient-to-r from-[#daa520]/10 to-[#ebbe41]/10 border-b-2 border-[#daa520]/30 p-6 backdrop-blur-sm">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                  <div className="bg-gradient-to-br from-[#daa520]/30 to-[#daa520]/10 rounded-xl p-3 border border-[#daa520]/40">
                    <Cookie className="h-7 w-7 text-[#daa520]" />
                  </div>
                  <div>
            ...
            <div className="p-6 md:p-8 space-y-6 overflow-y-auto max-h-[calc(90vh-200px)]">
              <div className="bg-[#daa520]/5 rounded-xl p-5 border border-[#daa520]/20">
              ...
              <div className="space-y-4">
                {/* Essential Cookies */}
                <div className="group bg-gradient-to-br from-white/5 to-white/[0.02] rounded-xl p-6 border-2 border-white/10 hover:border-[#daa520]/30 transition-all">
                  <div className="flex items-start justify-between gap-4 mb-3">
                    ...
                    <div className="flex-shrink-0 bg-[#daa520]/20 text-[#daa520] px-4 py-2 rounded-lg text-xs font-bold uppercase tracking-wider border border-[#daa520]/30">
                      Uvijek aktivni
                    </div>
                  </div>
                </div>
                ...
                <div className="group bg-gradient-to-br from-white/5 to-white/[0.02] rounded-xl p-6 border-2 border-white/10 hover:border-[#daa520]/30 transition-all">
                  <div className="flex items-start justify-between gap-4 mb-3">
                    <div className="flex-1">
                      <div className="flex items-center gap-2 mb-2">
                        <svg className="h-5 w-5 text-[#daa520]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                          <path
                            strokeLinecap="round"
                    ...
                    <label className="relative inline-flex items-center cursor-pointer flex-shrink-0">
                      ...
                      />
                      <div className="w-14 h-7 bg-white/10 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-[#daa520]/20 rounded-full peer peer-checked:after:translate-x-full rtl:peer-checked:after:-translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:start-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-6 after:w-6 after:transition-all peer-checked:bg-[#daa520] border-2 border-white/20 peer-checked:border-[#daa520]"></div>
                    </label>
                  </div>
                </div>
              ...
              <div className="pt-4 border-t-2 border-white/10">
                <p className="text-sm text-gray-400 mb-6">
                  ...
                  <Link
                    ...
                    className="text-[#daa520] hover:text-[#ebbe41] underline font-semibold transition-colors"
                  >
                ...
                <div className="flex gap-3 flex-col sm:flex-row">
                  <button
                    onClick={acceptCookies}
                    className="bg-gradient-to-r from-[#daa520] to-[#ebbe41] hover:from-[#ebbe41] hover:to-[#f5d76e] text-[#0a0c10] px-8 py-4 rounded-xl font-bold transition-all shadow-lg shadow-[#daa520]/30 hover:shadow-xl hover:shadow-[#daa520]/40 uppercase tracking-wider text-sm flex-1 flex items-center justify-center gap-2 hover:scale-105"
                  >
                    <Check className="h-5 w-5" />
                  ...
                  <button
                    ...
                    className="bg-white/10 hover:bg-white/20 text-white px-8 py-4 rounded-xl font-bold transition-all border-2 border-white/20 hover:border-[#daa520]/50 uppercase tracking-wider text-sm flex-1"
                  >
                    Spremi odabir
                  </button>
                  <button
